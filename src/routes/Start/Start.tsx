...
const Start: FC = () => (
  <>
    <title>FnA Labs | Hive^io - Get Started</title>
    <meta name="description" content="Get started with Hive^io: a reactive, cloud-native framework. Follow along with the setup instructions and multiple examples." />
    ...
    <Block article content>
      ...
      <Notification color='info' light>The Development process for domain logic only requires a Text Editor or IDE that supports JavaScript and Node.js/Docker. The rest of the instructions outlined here provide infrastructure details for installation and deployment.</Notification>

  ...
  renderBreadcrumbs () {
    return (
      <>
        ...
        <li className='is-active'><Link to='/environments' aria-current='page'>Environments</Link></li>
  ...
  render () {
    ...
    return (
      <>
        ...
        <NextPageHero breadcrumbs={this.renderBreadcrumbs} toLeft='/documentation' toRight='https://fnalabs.github.io/hive-js/' />
      </>
    )
  }
}

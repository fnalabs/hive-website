...
export const Intro = () => (
  <Fragment>
    <h1>Overview</h1>
    <p>Hive<sup>io</sup> is a <a href='https://www.reactivemanifesto.org/' target='_blank'>reactive</a>, <a href='https://www.cncf.io/blog/2017/05/15/developing-cloud-native-applications/' target='_blank'>cloud-native</a> framework meant to foster and support lightweight, atomic <a href='https://en.wikipedia.org/wiki/Microservices' target='_blank'>microservices</a> from a project's inception onward. It consists of a small library of classes that provide the basic building blocks to interface with a small collection of containers, from straightforward <a href='https://en.wikipedia.org/wiki/Representational_state_transfer' target='_blank'>RESTful</a> services to specialized <a href='https://martinfowler.com/bliki/CQRS.html' target='_blank'>CQRS</a>/<a href='https://martinfowler.com/eaaDev/EventSourcing.html' target='_blank'>ES</a> services. The core tenets of this project are:</p>
    <ul>

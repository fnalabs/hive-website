...
export const Infrastructure = () => (
  <>
    ...
    <p>Here are the execution environments for the business logic described previously. Hive<sup>io</sup> is designed to manage infrastructure as code through the base <a href='https://www.docker.com/' target='_blank' rel='noopener noreferrer'>Docker</a> images defined. These images are meant to be extended to include your business logic and additional code dependencies. Depending on the type of container, there are a few opinions made here too.</p>

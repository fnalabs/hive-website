...
export default class Start extends Component {
  ...
  renderBreadcrumbs () {
    return (
      <>
        <li className='is-active'><Link to='/start' aria-current='page'>Get Started</Link></li>
  ...
  render () {
    ...
    return (
      <>
        ...
        <NextPageHero breadcrumbs={this.renderBreadcrumbs} toLeft='/infrastructure' toRight='/setup' />
      </>
    )
  }
}

...
export const ExampleREST = () => (
  <>
    ...
    <h5><a href='https://www.npmjs.com/package/hive-io-rest-example' target='_blank' rel='noopener noreferrer'>Business Logic</a> (<a href='https://github.com/fnalabs/hive-js-rest-example' target='_blank' rel='noopener noreferrer'>Source Code</a>)</h5>
    ...
    <dl>
      ...
      <dd>
        <pre>FROM fnalabs/hive-rest-js:latest<br />RUN npm install hive-io-rest-example</pre>
      </dd>

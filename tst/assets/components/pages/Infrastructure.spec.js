...
describe('<Infrastructure />', () => {
  it('should render Infrastructure page static content', () => {
    const tree = renderer.create(<MemoryRouter><Infrastructure location={{ pathname: '/infrastructure' }} /></MemoryRouter>).toJSON()
  ...
  it('should render Infrastructure page static content and report page view', () => {
    shallow(<Infrastructure location={{ pathname: '/infrastructure' }} />, {
